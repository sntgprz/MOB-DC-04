...
protocol StudentDelegate {
    func addStudent(newStudent newStudent: DummyStudent)
}
...
class AddViewController: UIViewController, UITextFieldDelegate {
    ...
    // SP - Create a DataLogic object to be able to use the logic within the DataLogic class.
    
    var myDataLogic: DataLogic
    
    // SP - Reference the App Delegate
    ...
    @IBAction func save(sender: UIBarButtonItem) {
        ...
        // SP - The three lines of code below have been superseded. We no longer need a new constant for student.
        // If we get here we know that both fields have a value
        // So we create a new student
        let newStudent = DummyStudent(name: nameField.text!, location: locationField.text!)
        
        //SP - Implement the DataLogic method to store a student in the database
        
        myDataLogic.saveData(self.nameField.text!, locationToSave: self.locationField.text!)
